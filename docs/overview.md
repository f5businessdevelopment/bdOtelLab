...
This self-guided lab is intended to provide a hands-on introduction to Open Telemetry (OTel) concepts and their implementation.  During this lab, attendees will utilize a <a href="https://udf.f5.com" target="_blank">UDF</a> blueprint deploy the lab infrastructure shown below to:
